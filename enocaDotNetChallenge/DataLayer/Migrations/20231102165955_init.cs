    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CarrierConfigrations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CarrierConfigrations_Carriers_CarrierId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarrierConfigrations_CarrierId",
                table: "CarrierConfigrations",
                column: "CarrierId");
